...
def predict_posture(frame, posture_monitor):
    try:
        return posture_monitor.run(frame)
    except Exception as e:
        print(f"Error in predict_posture: {e}")
        return None
...
def maintain_max_files(directory, max_files, ext_media_sequence):
    try:
        ...
        print(f"Error in maintain_max_files: {e}")
        return ext_media_sequence
...
def get_file_creation_time(file_path):
    try:
        ...
        print(f"Error in get_file_creation_time: {e}")
...
def get_next_file_to_process(process_path):
    try:
        ...
        print(f"Error in get_next_file_to_process: {e}")
        return None
...
def update_m3u8(ts_file, ts_duration, m3u8_filename, config):
    try:
        ...
        print(f"Error in update_m3u8: {e}")
